...
public class RegexUtil {
    ...
    private static final Pattern PATTERN_PHONE = Pattern.compile("^((13[0-9])|(17[0-9])|(15[0-9])|(18[0-9]))\\d{8}$");
    ...
    private static final Pattern PATTERN_JSONP = Pattern.compile("^[a-zA-Z_$][0-9a-zA-Z_$]*[\\s]*\\(([^\\)]*)\\)[\\s]*[;]*$");
